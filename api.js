...
class API {
    ...
    static async getCoins() {
        try {
            // Актуальные цены на монеты в рублях
            const defaultCoins = [
                { symbol: "BTC", name: "Bitcoin", price: 6750000.0, marketCap: 132000000000000 },
                { symbol: "ETH", name: "Ethereum", price: 385000.0, marketCap: 46200000000000 },
                { symbol: "SOL", name: "Solana", price: 18000.0, marketCap: 7800000000000 },
                { symbol: "ADA", name: "Cardano", price: 45.0, marketCap: 1580000000000 },
                { symbol: "DOT", name: "Polkadot", price: 725.0, marketCap: 950000000000 },
                { symbol: "XRP", name: "Ripple", price: 58.0, marketCap: 3150000000000 },
                { symbol: "DOGE", name: "Dogecoin", price: 12.0, marketCap: 1720000000000 },
                { symbol: "AVAX", name: "Avalanche", price: 3520.0, marketCap: 1280000000000 },
                { symbol: "LINK", name: "Chainlink", price: 1575.0, marketCap: 920000000000 },
                { symbol: "MATIC", name: "Polygon", price: 65.0, marketCap: 630000000000 }
            ];
